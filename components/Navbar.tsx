...
const Navbar = () => {
 ...
 <div className="sticky top-0 z-10 py-2 px-10 flex gap-2 justify-between items-center bg-white max-sm:px-2">
      <Link href="/">
        <Image src="/logocompleto.png" alt="logo" width={150} height={100
        } />
      </Link>
  ...
  <input
      ...
      {/* condiciones para usar los divs */}
   ...
   FAVORITOS
    ...
    ORDENES
       ...
       <Link
        ...
        >
      <ShoppingCart/>
      <p className="text-base-bold max-sm:max-w-[50px]"> Cart ({cart.cartItems.length})</p>
      </Link>
